...
export const getConfig = async () => {
	...
	if (!cachedConfig) {
		...
		// Build cargo args with license properties if configured
		const cargoArgs = ["cargo:run", `-P${profileConfig.profile}`];
		
		// Add license properties as system properties for extended-bootstrap module
		// The extended-bootstrap module will read these and configure the license via YAML bootstrap
